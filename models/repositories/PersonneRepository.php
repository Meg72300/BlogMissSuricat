...
class PersonneRepository
{
	...
	public function getPersonne($pdo, $login, $password) {
		...
		$resultat = $pdo->prepare('SELECT id, nom, prenom, login, password FROM personne WHERE login = :login AND password = :password');
